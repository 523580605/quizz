...
const questions = [
  {
    question: 'Os números 500 e 1345 tem seus valores em binário, respectivamente, iguais a:',
    answers: [
      {
  ...
  {
    question: 'Fazendo o processo inverso agora, transforme o numero 1111 em sua forma decimal:',
    answers: [
      {
        answer: '20',
        correct: false,
